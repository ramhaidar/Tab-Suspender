...
this.manifest = {
	...
	settings: [
		...
		},
		{
			...
			type: 'checkbox',
			label:
				'Auto-Suspend tabs only when... <!--Battery Level less then next value and power cord detached <font color="#0099FF">(New)</font-->'
		},
		{
			tab: 'Suspend Settings',
			group: 'Battery',
...

		{
			...
			type: 'listBox',
			options: [
				['roundIcon', 'Blue Round Icon at the center of the page - Default'],
				['noIcon', 'No Icon - Only page screenshot'],
				['topBar', 'Semi-transparent bar at the top of the page']
			],
